...
const routes: Routes = [
  ...
  {
    path: 'appraisal-hr-scren',
    loadChildren: () => import('./pages/appraisal/appraisal-hr-scren/appraisal-hr-scren.module').then( m => m.AppraisalHrScrenPageModule)
  },
  {
    path: 'create-appraisal',
    loadChildren: () => import('./pages/appraisal/create-appraisal/create-appraisal.module').then( m => m.CreateAppraisalPageModule)
  },
  {
  ...
  {
    path: 'appraisa-view-scren',
    loadChildren: () => import('./pages/appraisal/appraisa-view-scren/appraisa-view-scren.module').then( m => m.AppraisaViewScrenPageModule)
  },
  {
...
const routes: Routes = [
  ...
  {
    path: 'appraisal-main-scren',
    loadChildren: () => import('./pages/appraisal-main-scren/appraisal-main-scren.module').then( m => m.AppraisalMainScrenPageModule)
  },
  {
    path: 'appraisal-hr-scren',
    loadChildren: () => import('./pages/appraisal-hr-scren/appraisal-hr-scren.module').then( m => m.AppraisalHrScrenPageModule)
  },
  {
